...
public interface IAppraisalService {
    Appraisal createAppraisal(AppraisalDTO appraisalDTO, Long userId) throws DataNotFoundException, ResourceAlreadyExistsException;
    ...
    Appraisal updateAppraisal(long id, AppraisalDTO appraisalDTO, Long userId) throws DataNotFoundException;
